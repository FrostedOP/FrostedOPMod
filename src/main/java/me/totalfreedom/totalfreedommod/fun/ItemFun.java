        ...
        switch (event.getMaterial())
        {
            case RAW_FISH:
            {
                ...
                if (!plugin.al.isSeniorAdmin(player))
                {
                    ...
                    final char[] chars = ("You are a clown. :LLLLLLLL").toCharArray();
                    for (char c : chars)
                    {
                ...
                if (didHit)
                {
                    ...
                    for (Sound sound : sounds)
                    {
                        ...
                        {
                            playerLoc.getWorld().playSound(randomOffset(playerLoc, 5.0), sound, 100.0f, randomDoubleRange(1, 7.0).floatValue());
                        }
                    }
                }
                break;
