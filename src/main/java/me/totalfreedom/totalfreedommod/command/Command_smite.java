...
public class Command_smite extends FreedomCommand
{
    ...
    public static void smite(Player player, String reason, CommandSender sender)
    {
        FUtil.bcastMsg(player.getName() + " has been a naughty, naughty boy.", ChatColor.RED);

        if (reason != null)
        {
            FUtil.bcastMsg(ChatColor.RED + "  Reason: " + reason + " (" + sender.getName() + ")");
        }
