...
public class Command_fml extends FreedomCommand
{
    ...
    public static void smite(Player player, String reason)
    {
        ...
        if (reason != null)
        {
            FUtil.bcastMsg(" Just wants to kill " + reason, ChatColor.RED);
        }
        ...
        if (reason != null)
        {
            player.sendMessage(ChatColor.RED + "If you want to die, Do it the correct way! =" + reason);
        }
    }
}
