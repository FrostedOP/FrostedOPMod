...
public class Command_vanish extends FreedomCommand
{
    ...
    public boolean run(CommandSender sender, Player playerSender, Command cmd, String commandLabel, String[] args, boolean senderIsConsole)
    {
        ...
        if (vanished.contains(playerSender))
        {
            ...
            FUtil.bcastMsg(ChatColor.DARK_GRAY + "(" + ChatColor.GREEN + "+" + ChatColor.DARK_GRAY + ")" + playerSender.getName() + ChatColor.GRAY + " has joined the game!");
        ...
        else if (!(vanished.contains(playerSender)))
        {
            ...
            FUtil.bcastMsg(ChatColor.DARK_GRAY + "(" + ChatColor.RED + "-" + ChatColor.DARK_GRAY + ")" + playerSender.getName() + ChatColor.GRAY + " has left the game!");
